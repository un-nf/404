...
- **Backwards-incompatible changes will be deliberate.** From here on, breaking changes will be intentional, documented, and part of a proper release cycle—not accidental fallout from a late-night refactor.
- **If it breaks, it's a bug.** Before, issues were expected. Now, they're regressions.
...
The ad-hoc certificate generation from early versions is gone.
