...
- If a struct contains non-Debug types (e.g., `rcgen::Certificate`), implement custom `Debug` manually:
  ...
  ```
- This is production-grade: avoids exposing sensitive/non-debuggable internals, satisfies trait bounds.
...
- **Solution:** Priority chain for host resolution:
  ...
  4. Fallback: "example.com" (should never hit this in production)
